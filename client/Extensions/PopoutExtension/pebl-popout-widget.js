...
jQuery(document).ready(function () {
    ...
    jQuery('.popout_popoutExtension, .peblExtension[data-peblextension="popout"], .peblExtension[data-peblExtension="popout"]').each(function () {
        ...
        var content = jQuery(this)[0].getAttribute('data-content').replace(/&lt;br\/>/g, '<br/>');
...
popout.createPopout = function (insertID, title, content, iconType) {
    ...
    var popoutWrapper = document.createElement('div');
    popoutWrapper.setAttribute('data-theme-target', insertID);
    ...
    popoutWrapper.appendChild(popoutDiv);
    ...
    insertLocation.parentNode.insertBefore(popoutWrapper, insertLocation);
